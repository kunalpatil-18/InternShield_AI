...
- Studied existing systems and identified limitations:
  - Manual verification
  - Lack of automation
...
- Added mandatory dropdowns for behavioral scam signals:
  - Logo
  - Remote
  - Questions
...
- Implemented ColumnTransformer to simultaneously process:
  - TF-IDF text features
  - Numerical verification indicators
...
- Saved trained XGBoost model and preprocessor as `.pkl` files.

- Integrated model with Flask backend via Pandas DataFrame formatting.
...
- System successfully classified internships into categories using:
  - Text features
  - Behavioral features
...
### Features
- Takes internship text details and verification indicators as input
- Uses ColumnTransformer to combine:
  - TF-IDF feature extraction
  - Numerical behavioral indicators
- Uses XGBoost model for prediction
- Classifies internships into:
  - Genuine
  - Suspicious
  - Fraudulent
- Provides percentage risk score
...
- Detect fraud using internship offer letter images
- OCR integration for extracting text from documents
- Browser extension for real-time internship verification
- Integration with official company databases
