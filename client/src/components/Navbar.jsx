      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <Link to="/contact" className="text-gray-600 hover:text-teal-700 font-semibold transition-colors">REPORT</Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 absolute w-full left-0 shadow-lg">
          <div className="px-2 pt-2 pb-4 space-y-2 flex flex-col items-center">
            ...
            <Link to="/resources" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-gray-600 hover:text-teal-700 font-semibold">RESOURCES</Link>
          </div>
        </div>
      )}
    </nav>
